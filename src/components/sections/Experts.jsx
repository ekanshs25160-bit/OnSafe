    ...
    <section className="team-section py-24 px-[10%] bg-bg-base overflow-hidden border-t border-white/5">
      <div className="mb-16">
        ...
        <p className="text-white/60 text-lg md:text-xl max-w-4xl font-inter leading-relaxed">
          Access a vetted network of independent cybersecurity practitioners specialized in securing early-stage MVPs. Our experts are verified through a rigorous onboarding protocol to ensure your startup receives trusted, affordable, and expert-led remediation.
        </p>
      </div>
            ...
            <div key={i} className="group relative bg-[#0b111a] p-8 rounded-2xl border border-white/5 hover:border-[#39ff14]/40 transition-all duration-500">
              ...
              <div className="flex justify-between items-center mb-6 border-b border-white/5 pb-4">
                <div className="flex items-center gap-2">
                   ...
                   <span className="text-[10px] uppercase font-mono tracking-widest text-[#39ff14]">Verified Professional</span>
                </div>
              ...
              <div className="space-y-3 font-mono text-[10px] text-white/50 tracking-wider">
                 <div className="flex justify-between items-center bg-white/5 p-2 rounded">
                    ...
                    <span className="text-white/80">{op.specialties ? op.specialties.join(", ").replace(/#/g, '') : "Security Research"}</span>
                 </div>
                 <div className="flex justify-between items-center bg-white/5 p-2 rounded">
                    <span>LEGAL STATUS:</span>
                    <span className="text-[#d1b3ff] flex items-center gap-1"><span className="material-symbols-outlined text-[14px]">gavel</span> NDA-BOUND</span>
                 </div>
              </div>
